...
export default function Route({ loaderData }: Route.ComponentProps) {
  return (
    <Center>
      <Link to="/profile" className="absolute top-2 left-2">← Voltar</Link>
      <h1 className="text-lg flex justify-center">Editar Profile</h1>
      <Spacer size="md" />
      <Form method="post">
        <TextInput id="name" name="name" label="Nome" type="text" required={true} defaultValue={loaderData.currentUser.name} />
        <Spacer size="sm" />
